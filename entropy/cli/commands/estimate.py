...
def estimate_command(
    ...
    Example:
        entropy estimate scenario.yaml
        entropy estimate scenario.yaml --model gpt-5-mini
        entropy estimate scenario.yaml --pivotal-model gpt-5 --routine-model gpt-5-mini -v
    """
