...
2. Build pairs: (initiator, target, topic, edge_weight)
3. Sort by edge_weight descending
4. Identify conflicts (same agent appears in multiple pairs)
5. Non-conflicting pairs → parallel execution
6. Conflicting pairs → sequential execution, highest weight first
...
| 3.10c internal monologue | No | No | Yes |
| 3.10d repetition detection | No | No | Yes |
| 3.10e episodic/semantic memory | No | Yes | Yes |
| 3.10f attention weighting | No | No | Yes |
| 3.10g spontaneous recall | No | No | Yes |
...
- Tier 1 (easy): emotional trajectory, conviction self-awareness, internal monologue
- Tier 2 (medium): repetition detection, episodic/semantic memory
- Tier 3 (advanced): attention weighting, spontaneous recall
