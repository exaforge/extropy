...
def extend_command(
    ...
    Example:
        extropy extend surgeons_base.yaml -s "AI diagnostic tool adoption" -o surgeons_ai.yaml
        extropy extend farmers.yaml -s "Drought response behavior" -o farmers_drought.yaml
    """
