...
def sample_command(
    ...
    EXAMPLES:
        extropy sample surgeons.yaml -o agents.json
        extropy sample surgeons.yaml -n 500 -o agents.json --seed 42
        extropy sample surgeons.yaml -n 1000 -o agents.db --format sqlite
        extropy sample surgeons.yaml -o agents.json --report
        extropy --json sample surgeons.yaml -o agents.json --report
    """
