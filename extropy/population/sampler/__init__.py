"""Sampler module for Extropy population generation.
...
Usage:
    from extropy.sampler import sample_population, save_json, save_sqlite
...
Pipeline Position:
    1. extropy spec → base spec (surgeons.yaml)
    2. extropy extend → merged spec (surgeons_ai.yaml) — optional
    3. extropy sample → agents from whichever spec you provide
"""
